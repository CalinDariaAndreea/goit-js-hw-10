...
document.querySelector(".breed-select").addEventListener("change", (event)=>{
    (0, _catApiJs.fetchCatByBreed)(event.target.value);
});
...
(0, _axiosDefault.default).defaults.headers.common["x-api-key"] = "live_WZ0r6zgHborF4Jg9j4xlzx1Zb4D4fGVF7nT4U7q1kmlpBrV4sfJRR1433qdrDZxO";
async function fetchBreeds() {
    ...
    (0, _axiosDefault.default).get("https://api.thecatapi.com/v1/breeds").then((response)=>{
        ...
        document.querySelector(".loader").style.display = "none";
        document.querySelector(".breed-select").style.display = "none";
        (0, _notiflixDefault.default).Report.failure("Error fetching breeds", "Oops! Something went wrong!", "OK");
...
async function fetchCatByBreed(breedId) {
    ...
    (0, _axiosDefault.default).get(`https://api.thecatapi.com/v1/images/search?breed_ids=${breedId}`).then((response)=>{
      ...
      `;
        ...
        document.querySelector(".loader").style.display = "none";
        document.querySelector(".cat-info").style.display = "none";
        (0, _notiflixDefault.default).Report.failure("Error fetching cat info", "Oops! Something went wrong!", "OK");
